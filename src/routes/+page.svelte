<script lang="ts">
	...
	const examples = [
		...
		{ slug: 'static-grid', title: 'Static Grid', description: 'Fixed rows or columns with item size.' },
		{
			...
			description: 'Infinite grid growth when rows or cols are zero.'
		},
	...
	<div class="mx-auto max-w-6xl px-6 py-12">
		...
		<header class="mb-10">
			<div class="flex items-center justify-between mb-4">
				<span class="badge badge-primary badge-lg font-semibold tracking-wide"> Svelte Grid Extended </span>
